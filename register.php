...
?>
<h1 class="<?php echo $site_color_accent_text; ?>">User Registration</h1>
<?php
$showFormular = true; //Flag to display the registration form
...
if ( isset( $_GET['register'] ) ) {
	...
	if ( ! $error ) {
		...
		if ( $result ) {
			echo '<p>You have been successfully registered. <a href="login.php">Login here</a></p>';
			$showFormular = false;
		} else {
    ...
    <div class="row">
        <form action="?register=1" method="post" class="col s12">
            ...
            <div class="input-field col s12 m6">
                ...
                <label for="inputPasswort">Your password</label>
            ...
            <div class="input-field col s12 m6">
                ...
                <label for="inputPasswort2">Password confirmation</label>
            ...
            <button type="submit" class="<?php echo $site_color_accent; ?> btn waves-effect waves-light col s12 m6 l3">
                Register<i class="material-icons right">send</i></button>
        </form>
    </div>
